...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see mx.um.edu.medicina.service.impl.PasswordTokenManager#generateRecoveryToken(mx.um.edu.medicina.model.User)
     */
    @Override
    ...
    /**
     * @see mx.um.edu.medicina.service.impl.PasswordTokenManager#isRecoveryTokenValid(mx.um.edu.medicina.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see mx.um.edu.medicina.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
